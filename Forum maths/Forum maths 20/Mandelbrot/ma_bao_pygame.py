...
class Case_a_cocher:
    ...
    def __init__(self,position, texte = "",dim = dimension,cochee=False,fonction=None):
        """
        Indiquer la position, la dimension, le texte à afficher à coté, et si la case est cochée ou pas
        """
